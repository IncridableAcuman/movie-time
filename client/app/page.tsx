...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="pdg">
        <h1 className="text-lg md:text-2xl py-2 md:py-6 font-semibold">{`960 dan ortiq filmlarga ega onlayn kinoteatr bo'lgan KinoVaqtiga xush kelibsiz!+`}</h1>
        <p>
              ...
              Biz turli janr va janrlardagi filmlarning keng tanlovini taklif etamiz - klassikadan
                ...
                KinoVaqtida siz sevimli filmlaringizni istalgan vaqtda, istalgan joyda yuqori sifatli 
